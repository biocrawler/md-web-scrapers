...
public enum MetricPaths {
    PRODUCER_ARTICLE_SEND_SUCCESS("mdcrawler.fosshost.producer.send.article.success.count"),
    PRODUCER_ATICLE_SEND_ERROR("mdcrawler.fosshost.producer.send.article.fail.count"),
